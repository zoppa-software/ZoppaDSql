...
Namespace Analysis.Tokens
    ...
    ''' <summary>論理積トークン。</summary>
    Public NotInheritable Class AndToken
        Implements IToken

        ''' <summary>遅延インスタンス生成プロパティ。</summary>
        Private Shared ReadOnly Property LazyInstance() As New Lazy(Of AndToken)(Function() New AndToken())

        ''' <summary>唯一のインスタンスを返します。</summary>
        Public Shared ReadOnly Property Value() As AndToken
            Get

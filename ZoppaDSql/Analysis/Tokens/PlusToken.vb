...
Namespace Analysis.Tokens
    ...
    ''' <summary>加算トークン。</summary>
    Public NotInheritable Class PlusToken
        Implements IToken

        ''' <summary>遅延インスタンス生成プロパティ。</summary>
        Private Shared ReadOnly Property LazyInstance() As New Lazy(Of PlusToken)(Function() New PlusToken())

        ''' <summary>唯一のインスタンスを返します。</summary>
        Public Shared ReadOnly Property Value() As PlusToken
            Get

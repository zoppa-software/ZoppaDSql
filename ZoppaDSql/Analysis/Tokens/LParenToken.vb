...
Namespace Analysis.Tokens
    ...
    ''' <summary>左括弧トークン。</summary>
    Public NotInheritable Class LParenToken
        Implements IToken

        ''' <summary>遅延インスタンス生成プロパティ。</summary>
        Private Shared ReadOnly Property LazyInstance() As New Lazy(Of LParenToken)(Function() New LParenToken())

        ''' <summary>唯一のインスタンスを返します。</summary>
        Public Shared ReadOnly Property Value() As LParenToken
            Get

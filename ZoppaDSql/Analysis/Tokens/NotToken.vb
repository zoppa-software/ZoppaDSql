...
Namespace Analysis.Tokens
    ...
    ''' <summary>否定トークン。</summary>
    Public NotInheritable Class NotToken
        Implements IToken

        ''' <summary>遅延インスタンス生成プロパティ。</summary>
        Private Shared ReadOnly Property LazyInstance() As New Lazy(Of NotToken)(Function() New NotToken())

        ''' <summary>唯一のインスタンスを返します。</summary>
        Public Shared ReadOnly Property Value() As NotToken
            Get

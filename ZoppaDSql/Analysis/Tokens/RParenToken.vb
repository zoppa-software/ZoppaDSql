...
Namespace Analysis.Tokens
    ...
    ''' <summary>右括弧トークン。</summary>
    Public NotInheritable Class RParenToken
        Implements IToken

        ''' <summary>遅延インスタンス生成プロパティ。</summary>
        Private Shared ReadOnly Property LazyInstance() As New Lazy(Of RParenToken)(Function() New RParenToken())

        ''' <summary>唯一のインスタンスを返します。</summary>
        Public Shared ReadOnly Property Value() As RParenToken
            Get

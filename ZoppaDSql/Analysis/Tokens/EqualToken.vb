...
Namespace Analysis.Tokens
    ...
    Public NotInheritable Class EqualToken
        Implements IToken

        ''' <summary>遅延インスタンス生成プロパティ。</summary>
        Private Shared ReadOnly Property LazyInstance() As New Lazy(Of EqualToken)(Function() New EqualToken())

        ''' <summary>唯一のインスタンスを返します。</summary>
        Public Shared ReadOnly Property Value() As EqualToken
            Get

...
Namespace Analysis.Tokens
    ...
    ''' <summary>以上トークン。</summary>
    Public NotInheritable Class GreaterEqualToken
        Implements IToken

        ''' <summary>遅延インスタンス生成プロパティ。</summary>
        Private Shared ReadOnly Property LazyInstance() As New Lazy(Of GreaterEqualToken)(Function() New GreaterEqualToken())

        ''' <summary>唯一のインスタンスを返します。</summary>
        Public Shared ReadOnly Property Value() As GreaterEqualToken
            Get
        ...
        Public ReadOnly Property TokenName As String Implements IToken.TokenName
            Get
                Return NameOf(GreaterEqualToken)
            End Get
        End Property

...
Namespace Analysis.Tokens
    ...
    ''' <summary>除算トークン。</summary>
    Public NotInheritable Class DivToken
        Implements IToken

        ''' <summary>遅延インスタンス生成プロパティ。</summary>
        Private Shared ReadOnly Property LazyInstance() As New Lazy(Of DivToken)(Function() New DivToken())

        ''' <summary>唯一のインスタンスを返します。</summary>
        Public Shared ReadOnly Property Value() As DivToken
            Get

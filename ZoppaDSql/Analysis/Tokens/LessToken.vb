...
Namespace Analysis.Tokens
    ...
    Public NotInheritable Class LessToken
        Implements IToken

        ''' <summary>遅延インスタンス生成プロパティ。</summary>
        Private Shared ReadOnly Property LazyInstance() As New Lazy(Of LessToken)(Function() New LessToken())

        ''' <summary>唯一のインスタンスを返します。</summary>
        Public Shared ReadOnly Property Value() As LessToken
            Get

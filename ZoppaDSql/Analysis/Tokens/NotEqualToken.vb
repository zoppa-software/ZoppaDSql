...
Namespace Analysis.Tokens
    ...
    ''' <summary>不等号トークン。</summary>
    Public NotInheritable Class NotEqualToken
        Implements IToken

        ''' <summary>遅延インスタンス生成プロパティ。</summary>
        Private Shared ReadOnly Property LazyInstance() As New Lazy(Of NotEqualToken)(Function() New NotEqualToken())

        ''' <summary>唯一のインスタンスを返します。</summary>
        Public Shared ReadOnly Property Value() As NotEqualToken
            Get

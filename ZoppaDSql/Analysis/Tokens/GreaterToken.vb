...
Namespace Analysis.Tokens
    ...
    Public NotInheritable Class GreaterToken
        Implements IToken

        ''' <summary>遅延インスタンス生成プロパティ。</summary>
        Private Shared ReadOnly Property LazyInstance() As New Lazy(Of GreaterToken)(Function() New GreaterToken())

        ''' <summary>唯一のインスタンスを返します。</summary>
        Public Shared ReadOnly Property Value() As GreaterToken
            Get

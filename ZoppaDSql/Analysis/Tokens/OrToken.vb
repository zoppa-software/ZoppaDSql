...
Namespace Analysis.Tokens
    ...
    ''' <summary>論理和トークン。</summary>
    Public NotInheritable Class OrToken
        Implements IToken

        ''' <summary>遅延インスタンス生成プロパティ。</summary>
        Private Shared ReadOnly Property LazyInstance() As New Lazy(Of OrToken)(Function() New OrToken())

        ''' <summary>唯一のインスタンスを返します。</summary>
        Public Shared ReadOnly Property Value() As OrToken
            Get

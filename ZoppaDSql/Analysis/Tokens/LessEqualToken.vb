...
Namespace Analysis.Tokens
    ...
    ''' <summary>以下トークン。</summary>
    Public NotInheritable Class LessEqualToken
        Implements IToken

        ''' <summary>遅延インスタンス生成プロパティ。</summary>
        Private Shared ReadOnly Property LazyInstance() As New Lazy(Of LessEqualToken)(Function() New LessEqualToken())

        ''' <summary>唯一のインスタンスを返します。</summary>
        Public Shared ReadOnly Property Value() As LessEqualToken
            Get
